        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockTracked = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownloadKey = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    AccessExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DownloadLimit = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalDownloads", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DigitalDownloads_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersItems", x => new { x.OrderId, x.ProductId, x.ProductVariantId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalDownloads_DownloadKey",
                table: "DigitalDownloads",
                column: "DownloadKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DigitalDownloads_ProductId",
                table: "DigitalDownloads",
                column: "ProductId",
                unique: true);
